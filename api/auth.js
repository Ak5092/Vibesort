...
module.exports = async function handler(req, res) {
  ...
  if (action === 'login') {
    ...
    const params = new URLSearchParams({
      ...
      scope:         'user-library-read playlist-read-private playlist-read-collaborative playlist-modify-private playlist-modify-public user-read-private user-read-email',
      show_dialog:   'false',
    });
